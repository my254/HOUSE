...
const Cart = () => {
  ...
  const [user, loadingA, error] = useAuthState(auth);
    ...
    //AdDOl_zO5Pzs2pe7UsZjo6OxdhnGAsiM6FfMeOpt6o3eUk8Gi_WfKaVweZoPJHBejMBbpudm6ozZm53c
    const getIntent = () => {
      loadScript({ "client-id": "Adl7PZK5ZPlkakR5HbYY51qYkJSx1U-mtgzVmc2-CZxdXS2X22kyADia75R-a46j7l4GEY5g6xO1LBUL" })
      .then((paypal) => {
        setC(true)
